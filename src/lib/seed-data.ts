...
export const CURRENT_HOLDINGS: Investment[] = [
  ...
  },
  {
    ...
    quantity: 0.05405769,
    purchasePrice: 121835.89,
    fees: 71.99,
    totalCost: 6586.54,
    currency: 'AUD',
    notes: 'Direct BTC holdings via crypto exchange. 10 buys from Jan 14 - Feb 12, 2026. DCA strategy ~$250-$1,500 per buy.',
    dataSource: 'manual'
  },
  {
    id: 'sharesight_ibtc',
  ...
  },
  {
    ...
    quantity: 1,
    purchasePrice: 3963.51,
    fees: 0,
    totalCost: 3963.51,
    currentPrice: 3963.51,
    currency: 'AUD',
...
export const ALL_TRADES: Trade[] = [
  ...
  {"date":"2026-02-12","type":"Buy","ticker":"BTC","exchange":"CRYPTO","name":"Bitcoin","qty":0.00395769,"price":96188.223,"brokerage":3.81,"currency":"AUD","value":384.49},
  // IBTC
